...
/**
 * CustomView Builder for RunWorkout entities.
 */
class RunWorkoutViewBuilder extends EntityViewBuilder
{
    /**
     * {@inheritdoc}
     */
    public function buildComponents(array &$build, array $entities, array $displays, $view_mode) {
        ...
        foreach ($entities as $id => $entity) {
            ...
            if (isset($build[$id]['type']) && ( $build[$id]['type'] == 'repeat')) {
                error_log("repeat found");
            }
            // $build[$id]['title'] = $entity->toLink();
